	...
	INSERT INTO meal(name,trans,description,image,price) VALUES 
		...
		('Huître','Oyster', '' , './images/hero1.jpg',18),
	('Foie gras','','Accompanied by toast and green salad.', './images/hero1.jpg',16),
	('Escargots','',' Cooking with marbled butters.','./images/hero1.jpg',14),
	('Plateau de charcuterie','Cold meats platter','Accompanied by butter and pickle.','./images/dishes/charcuterie.jpg',14),
	('Salade de chèvre chaud','Goat salad','','./images/hero1.jpg',12) ,
	...
	('Choucroute','','Composed of cabbage, sausage, potatoes, smoked streaky, pepper.','./images/hero1.jpg',20) ,
	('Raclette','','','./images/hero1.jpg',18),
	('Tartiflette','','Composed of potatoes, bacon, sour cream and re-blocks.','./images/hero1.jpg',22),
	('Fondue Bourguignogne','Bourguignone fondue','Served with beef, chicken and duck fillets.','./images/hero1.jpg',18),
	('Fondue savoyarde','Savoyarde fondue','Composed of Beauforts, counted and served with potatoes, pickles and onions.','./images/hero1.jpg',20),
	('Magret de canard','Duck breast fillet', 'Served with gratin dauphinois.','./images/hero1.jpg',24),
	('Ratatouille','','Diversity of vegetable (courgette, aubergines, tomatoes).','./images/dishes/ratatouille.jpg',17),
	('Cuisse de grenouille','Leg of frog','Accompanied by a salad.','./images/dishes/cuisse_de_grenouille.jpg',19) ,
	('Boeuf Bourguigon','','','./images/dishes/boeuf_bourgignon.jpg',17) ,
	...
	('Plateau de fromage','Cheese platter','Made of reblochon, counted, Savoy tomme, sheeps cheese, Roquefort.','./images/hero1.jpg',9),
	('Gâteaux basque','Basque cake', '','./images/dishes/gateaux_basque.jpg',11) ,
	...
	('Crumble','Crumble','','./images/hero1.jpg',12),
	('Tropezienne','','','./images/hero1.jpg',13),
	('Charlotte aux fraises','Strawberry charlotte','','./images/hero1.jpg',13),
	('Café gourmand','Coffe with dessert selection','Cannelé, chocolate éclair, chouquette, mini croissant.','./images/hero1.jpg',11.5),
	('Moules','mussels','','./images/dishes/moules.jpg',21) ,
	('Tarte aux onions','Onion tart','','./images/hero1.jpg',12) ,
	...
	('Tarte tatin','','','./images/dishes/tarte-tatin.jpg',12.5) ,
	('Bugnes','','','./images/dishes/bugnes.jpg',5.5) ,
	('Kouglof','','','./images/dishes/kouglof.jpg',6.5) ,
	('Tarte aux mirabelles','Mirabelle plum pies','','./images/hero1.jpg',6.5);
